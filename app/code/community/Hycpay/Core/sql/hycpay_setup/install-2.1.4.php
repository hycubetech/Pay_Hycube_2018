 ...
 */
$this->run(sprintf('DROP TABLE IF EXISTS `%s`;', $this->getTable('hycpay/ipn')));
$ipnTable = new Varien_Db_Ddl_Table();
$ipnTable->setName($this->getTable('hycpay/ipn'));
 ...
 */
$this->run(sprintf('DROP TABLE IF EXISTS `%s`;', $this->getTable('hycpay/invoice')));
$invoiceTable = new Varien_Db_Ddl_Table();
$invoiceTable->setName($this->getTable('hycpay/invoice'));
