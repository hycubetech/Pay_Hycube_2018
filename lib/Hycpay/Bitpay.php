...
use Hycpay\DependencyInjection\HycpayExtension;
use Hycpay\DependencyInjection\Loader\ArrayLoader;
...
class Hycpay
{
     ...
     * see \Hycpay\Config\Configuration class
     *
    ...
    {
        return array(
            'hycpay.root_dir' => realpath(__DIR__.'/..'),
        );
    }
