...
class Payout implements PayoutInterface
{
    ...
    /**
     * Set the batch ID as assigned from hycpay.
     *
     * @param $id
     * @return $this
     */
    ...
    /**
     * Set Account Id - Hycpays account ID for the payout.
     *
     * @param $id
     * @return $this
     */
    ...
    /**
     * Set the Bitcoin amount for this payout, once set by Hycpay.
     * @param $amount
     * @return $this
     */
    ...
    /**
     * Set Response Token - returned by Hycpay when payout request is created
     *
     * @param $responseToken
     * @return $this
     */
