...
interface PayoutInterface
{
    ...
    /**
     * Once Hycpay receives a corresponding ACH transfer from the payroll provider,
    ...
    /**
     * The batch ID of the payout assigned by Hycpay.com
     *
     * @return string
     */
    ...
    /**
     * Return the account parameter given by Hycpay.
     *
     * @return string
     */
     ...
     *
     * @return \Hycpay\CurrencyInterface
     */
     ...
     * Hycpay.com will send a POST request with a JSON encoding of the batch to this
